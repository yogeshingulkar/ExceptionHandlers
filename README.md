# Hackathon Repository – JavaScript Batch (A22)
...
git clone https://github.com/yogeshingulkar/ExceptionHandlers.git

2. Navigate to the project directory
cd ExceptionHandlers
...
Replace `filename.js` with the file you want to execute.
